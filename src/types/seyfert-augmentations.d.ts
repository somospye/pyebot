...
declare module "seyfert" {
  interface Button {
     ...
     */
    opens(modal: Modal, callback?: () => unknown | Promise<unknown>): this;
  }
  ...
  interface StringSelectMenu {
    onSelect(
      name: string,
      handler: (
        ctx: ComponentContext<"StringSelect">,
  ...
  interface UserSelectMenu {
    onSelect(
      name: string,
      handler: (
        ctx: ComponentContext<"UserSelect">,
      ) => unknown | Promise<unknown>,
    ): this;
  }
  interface RoleSelectMenu {
    onSelect(
      name: string,
      handler: (
        ctx: ComponentContext<"RoleSelect">,
      ) => unknown | Promise<unknown>,
    ): this;
  }
  interface ChannelSelectMenu {
    onSelect(
      name: string,
      handler: (
        ctx: ComponentContext<"ChannelSelect">,
      ) => unknown | Promise<unknown>,
    ): this;
  }
  interface MentionableSelectMenu {
    onSelect(
      name: string,
      handler: (
        ctx: ComponentContext<"MentionableSelect">,
      ) => unknown | Promise<unknown>,
    ): this;
  }
  interface GuildForumTagSelectMenu {
    onSelect(
      name: string,
      handler: (
        ctx: ComponentContext<"GuildForumTagSelect">,
      ) => unknown | Promise<unknown>,
    ): this;
  }
